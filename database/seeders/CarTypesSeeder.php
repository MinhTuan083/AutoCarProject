...
class CarTypesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('car_types')->insert([
            'name' => 'Crossover',
            'description' => 'Crossover là sự kết hợp giữa SUV và hatchback, thường được xây dựng trên nền tảng của sedan. Crossover thường nhẹ nhàng, tiết kiệm nhiên liệu và linh hoạt cho đi lại trong thành phố hoặc địa hình nhẹ.',
